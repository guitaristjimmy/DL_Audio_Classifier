...
# ./dataset/train/bed/00f0204f_nohash_0.wav
if __name__ == '__main__':
    with wave.open(f='./dataset/train/bird/3e7124ba_nohash_0.wav', mode='rb') as w:
    ...
    audio_data, sr = librosa.load(path='./dataset/train/bird/3e7124ba_nohash_0.wav', sr=None)
