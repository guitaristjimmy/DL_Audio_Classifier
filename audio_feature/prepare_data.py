...
if __name__ == '__main__':
    test_list = load_data_list(path='./speech_commands_v0.01/testing_list.txt')
    print(test_list)
    print('test_list loaded')
    for t in test_list:
        move_data(path_data=t, c='test/')
        print(t, 'moved')

    valid_list =  load_data_list(path='./speech_commands_v0.01/validation_list.txt')
